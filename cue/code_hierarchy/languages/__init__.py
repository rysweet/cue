...
__all__ = [
    ...
    'CsharpDefinitions', 'GoDefinitions', 'JavaDefinitions', 'JavascriptDefinitions',
    'PhpDefinitions', 'PythonDefinitions', 'RubyDefinitions', 'TypescriptDefinitions'
]
    ...
    for lang_name, (module_name, class_name) in _language_modules.items():
        if name == class_name:
            if name not in globals():
                try:
                    module = importlib.import_module(f'.{module_name}', package='cue.code_hierarchy.languages')
