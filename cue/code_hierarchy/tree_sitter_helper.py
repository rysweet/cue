...
from cue.graph.node.utils.node_factory import NodeFactory
...
if TYPE_CHECKING:
    ...
    from cue.graph.node import DefinitionNode, Node, FolderNode, FileNode
...
class TreeSitterHelper:
    ...
    def _try_process_body_node_snippet(self, node: "TreeSitterNode") -> Optional["TreeSitterNode"]:
        from cue.code_hierarchy.languages.language_definitions import BodyNodeNotFound
