...
from cue.project_file_explorer import ProjectFileStats
from cue.project_graph_updater import ProjectGraphUpdater
from cue.project_graph_diff_creator import PreviousNodeState, ProjectGraphDiffCreator
...
from cue.utils.file_remover import FileRemover
...
def main_update(updated_files: List[str], root_uri: Optional[str] = None, cueignore_path: Optional[str] = None) -> None:
    ...
    from cue.project_graph_updater import UpdatedFile
...
if __name__ == "__main__":
    ...
    #     file_diffs=[
    #         FileDiff(
    #             path="file:///home/juan/devel/blar/lsp-poc/cue/graph/node/utils/node_factory.py",
    #             diff_text="diff+++",
    #             change_type=ChangeType.ADDED,
    #         ),
    #         FileDiff(
    #             path="file:///home/juan/devel/blar/lsp-poc/cue/graph/relationship/relationship_type.py",
    #             diff_text="diff+++",
    #             change_type=ChangeType.ADDED,
    #         ),
    #         FileDiff(
    #             path="file:///home/juan/devel/blar/lsp-poc/cue/graph/relationship/relationship_creator.py",
    #             diff_text="diff+++",
    ...
    #             open("/home/juan/devel/blar/lsp-poc/cue/example", "r").read(),
    #         ),
    #         PreviousNodeState(
