import time
from cue.code_references import LspQueryHelper, FileExtensionNotSupported
from cue.project_file_explorer import ProjectFilesIterator
from cue.graph.node import NodeLabels, NodeFactory
from cue.graph.relationship.relationship_creator import RelationshipCreator
from cue.graph.graph import Graph
from cue.code_hierarchy import TreeSitterHelper
...
from cue.documentation import DocumentationGraphGenerator
import logging
...
if TYPE_CHECKING:
    from cue.graph.node import FolderNode
    from cue.project_file_explorer import File, Folder
    from cue.graph.node import Node, FileNode
...
class ProjectGraphCreator:
    ...
    def __init__(
        ...
        self.graph_environment = graph_environment or GraphEnvironment("cue", "repo", self.root_path)
