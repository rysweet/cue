...
import psutil
from cue.vendor.multilspy import SyncLanguageServer
...
from cue.vendor.multilspy.lsp_protocol_handler.server import Error

if TYPE_CHECKING:
    from cue.graph.node import DefinitionNode
...
class LspQueryHelper:
    ...
    def get_language_definition_for_extension(extension: str) -> Type["LanguageDefinitions"]:
        from cue.code_hierarchy.languages import get_language_definition, get_available_languages
