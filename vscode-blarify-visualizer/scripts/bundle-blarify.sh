...
# Bundle Blarify and its dependencies into the VS Code extension
...
echo "Bundling Blarify into VS Code extension..."
...
# Copy Blarify source
echo "Copying Blarify source..."
cp -r "$EXT_DIR/../blarify" "$BUNDLED_DIR/"
